...
if __name__ == "__main__":
    ...
    parser.add_argument("input_fasta", help="A .fasta file containing a protein.")
    parser.add_argument("input_peptides", help="A .txt file containing peptides.")
    parser.add_argument(
        "output_file", help="A .tsv output file to write the counts to."
    )
    parser.add_argument(
        "--amino_acid",
        default="C",
